...
const PadLibrarySource = ({route}) => {
    ...
    return(
        <View style={styles.container}>
            <Text style={styles.header}>All sounds from library</Text>
            <FlatList 
                data = {librarySounds}
                ...
                renderItem = {({item})=>
                    <View style={styles.itemContainer}>
                        ...
                        <View style={styles.buttonChooseContainer}>
                            <TouchableOpacity style={styles.buttonChoose} onPress={()=>changePadSource(item.id)}>
